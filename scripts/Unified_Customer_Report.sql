...
===============================================================================
Purpose:
    - Consolidate key customer metrics, attributes, and behavioral insights
      into a unified analytical view.

Highlights:
    I.   Extracts essential customer attributes (e.g., name, age) and
         transaction details.
    II.  Segments customers into meaningful categories (e.g., VIP, Regular,
         New) and age groups.
...
WITH base_query AS(
/*-----------------------------------------------------------------------------
	Base Query: Retrieve core columns from dim_customers and fact_sales
-----------------------------------------------------------------------------*/
SELECT 
	f.order_number,
	f.product_key,
